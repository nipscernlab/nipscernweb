...
> **Status em 23/08/2026.** A alocação foi executada. Todos os itens marcados
> IN abaixo entraram nos calendários e no `architect.html`, e a trilha de lógica
> passou de 57 para 88 textos. Fora ficaram apenas Savage, que este documento já
> marcava como apoio ao Jeffrey, e os itens marcados ✕. A análise abaixo
> permanece como registro de por que cada um entrou.
...
O plano já tem o lado da prova, com Gentzen, Troelstra e a dedução natural.
Falta o lado semântico: teoria de modelos (soundness, completude, compacidade, Löwenheim–Skolem). É *com isso* que se prova algo sobre uma lógica, que é exatamente o que um lógico filosófico faz ao inventar ou defender um sistema. É a peça mais importante da base formal.
...
Sobre os 57 atuais, a trilha de lógica vai de ~9,5 para ~14 textos/ano, um aumento real de ~45%, mas concentrado onde se quer profundidade, e boa parte são *papers* ou leituras de mapa, não tratados. Com grupos de estudo, é viável.
...
1. **Vizinhança da paraconsistência** (relevância + linear), que separa contribuição de recombinação.
