export const TRANSLATIONS = {
  en: {
    ...
    'tip-slicer': 'Slicer — drag the handle to sweep the cylindrical-wedge carve (Y: angle, X: height); right-drag to slide along the beam axis',
  ...
  fr: {
    ...
    'tip-slicer': 'Découpeur — glisser la poignée pour balayer la découpe en coin cylindrique (Y : angle, X : hauteur) ; clic droit pour translater le long de l\'axe du faisceau',
  ...
  no: {
    ...
    'tip-slicer': 'Kutter — dra håndtaket for å sveipe det sylindriske kilekuttet (Y: vinkel, X: høyde); høyredra for å flytte langs stråleaksen',
  ...
  pt: {
    ...
    'tip-slicer': 'Fatiador — arraste a alça para varrer o corte em cunha cilíndrica (Y: ângulo, X: altura); arraste com botão direito para mover ao longo do eixo do feixe',
