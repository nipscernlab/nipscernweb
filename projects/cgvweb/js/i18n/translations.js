export const TRANSLATIONS = {
  en: {
    ...
    'btn-live': 'Live', 'btn-sample': 'Samples',
    'sub-live-web': 'WEB', 'sub-live-server': 'SERVER',
    ...
    'server-empty': 'Pick a folder with JiveXML files. The 100 most recent are shown and refresh every 5s.',
    'server-refreshing': 'Refreshing folder…',
    'server-no-watch': 'Auto-refresh unavailable in this browser — re-pick the folder to see new files',
    ...
    'tip-slicer': 'Slicer — drag the handle to sweep the cylindrical-wedge carve (Y: angle wraps continuously, X: height); right-drag to slide the wedge along the Y/Z plane. Also fills the geometry with empty cells.',
  ...
  fr: {
    ...
    'btn-live': 'Direct', 'btn-sample': 'Exemples',
    'sub-live-web': 'WEB', 'sub-live-server': 'SERVEUR',
    ...
    'server-empty': 'Choisissez un dossier contenant des fichiers JiveXML. Les 100 plus récents sont affichés et rafraîchis toutes les 5 s.',
    'server-refreshing': 'Actualisation du dossier…',
    'server-no-watch': 'Actualisation automatique indisponible dans ce navigateur — re-sélectionnez le dossier pour voir les nouveaux fichiers',
    ...
    'tip-slicer': 'Découpeur — glisser la poignée pour balayer la découpe en coin cylindrique (Y : l\'angle s\'enroule en continu, X : hauteur) ; clic droit pour translater le coin dans le plan Y/Z. Remplit aussi la géométrie avec des cellules vides.',
  ...
  no: {
    ...
    'btn-live': 'Direkte', 'btn-sample': 'Eksempler',
    'sub-live-web': 'WEB', 'sub-live-server': 'SERVER',
    ...
    'server-empty': 'Velg en mappe med JiveXML-filer. De 100 nyeste vises og oppdateres hvert 5. sekund.',
    'server-refreshing': 'Oppdaterer mappen…',
    'server-no-watch': 'Auto-oppdatering er ikke tilgjengelig i denne nettleseren — velg mappen på nytt for å se nye filer',
    ...
    'tip-slicer': 'Kutter — dra håndtaket for å sveipe det sylindriske kilekuttet (Y: vinkelen går rundt kontinuerlig, X: høyde); høyredra for å flytte kilen i Y/Z-planet. Fyller også geometrien med tomme celler.',
  ...
  pt: {
    ...
    'btn-live': 'Ao Vivo', 'btn-sample': 'Amostras',
    'sub-live-web': 'WEB', 'sub-live-server': 'SERVIDOR',
    ...
    'server-empty': 'Escolha uma pasta com arquivos JiveXML. Os 100 mais recentes são exibidos e atualizados a cada 5 s.',
    'server-refreshing': 'Atualizando pasta…',
    'server-no-watch': 'Atualização automática indisponível neste navegador — re-selecione a pasta para ver novos arquivos',
    ...
    'tip-slicer': 'Fatiador — arraste a alça para varrer o corte em cunha cilíndrica (Y: o ângulo dá a volta continuamente, X: altura); arraste com botão direito para mover a cunha no plano Y/Z. Também preenche a geometria com células vazias.',
