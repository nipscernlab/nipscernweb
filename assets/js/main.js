...
import { initI18n, getLang, setLanguage } from './i18n.js?v=63799f47d6';

import { newsPostUrl } from './content-links.js?v=63799f47d6';
...
import { initSmoothScroll, scrollToTop, holdScroll } from './smooth-scroll.js?v=63799f47d6';
...
// <script src="main.js?v=63799f47d6">. Each copy would otherwise append its own
