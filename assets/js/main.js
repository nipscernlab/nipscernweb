...
import { initI18n, getLang, setLanguage } from './i18n.js?v=301ab40fbd';

import { newsPostUrl } from './content-links.js?v=301ab40fbd';
...
import { initSmoothScroll, scrollToTop, holdScroll } from './smooth-scroll.js?v=301ab40fbd';
...
// <script src="main.js?v=301ab40fbd">. Each copy would otherwise append its own
