...
import { initI18n, getLang, setLanguage } from './i18n.js?v=daf68d1e94';

import { newsPostUrl } from './content-links.js?v=daf68d1e94';
...
import { initSmoothScroll, scrollToTop, holdScroll } from './smooth-scroll.js?v=daf68d1e94';
...
// <script src="main.js?v=daf68d1e94">. Each copy would otherwise append its own
