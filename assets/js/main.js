...
import { initI18n, getLang, setLanguage } from './i18n.js?v=5be27fcda5';

import { newsPostUrl } from './content-links.js?v=5be27fcda5';
...
import { initSmoothScroll, scrollToTop, holdScroll } from './smooth-scroll.js?v=5be27fcda5';
...
// <script src="main.js?v=5be27fcda5">. Each copy would otherwise append its own
