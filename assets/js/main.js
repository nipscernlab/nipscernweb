...
import { initI18n, getLang, setLanguage } from './i18n.js?v=df6b1a345f';

import { newsPostUrl } from './content-links.js?v=df6b1a345f';
...
import { initSmoothScroll, scrollToTop, holdScroll } from './smooth-scroll.js?v=df6b1a345f';
...
// <script src="main.js?v=df6b1a345f">. Each copy would otherwise append its own
