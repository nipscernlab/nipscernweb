...
import { initI18n, getLang, setLanguage } from './i18n.js?v=9e6e3652e2';

import { newsPostUrl } from './content-links.js?v=9e6e3652e2';
...
import { initSmoothScroll, scrollToTop, holdScroll } from './smooth-scroll.js?v=9e6e3652e2';
...
// <script src="main.js?v=9e6e3652e2">. Each copy would otherwise append its own
