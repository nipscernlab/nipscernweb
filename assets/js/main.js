...
import { initI18n, getLang, setLanguage } from './i18n.js?v=52b6de4b3d';

import { newsPostUrl } from './content-links.js?v=52b6de4b3d';
...
import { initSmoothScroll, scrollToTop, holdScroll } from './smooth-scroll.js?v=52b6de4b3d';
...
// <script src="main.js?v=52b6de4b3d">. Each copy would otherwise append its own
