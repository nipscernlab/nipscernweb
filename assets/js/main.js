...
import { initI18n, getLang, setLanguage } from './i18n.js?v=5f7d6e32fa';

import { newsPostUrl } from './content-links.js?v=5f7d6e32fa';
...
import { initSmoothScroll, scrollToTop, holdScroll } from './smooth-scroll.js?v=5f7d6e32fa';
...
// <script src="main.js?v=5f7d6e32fa">. Each copy would otherwise append its own
