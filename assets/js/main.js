...
import { initI18n, getLang, setLanguage } from './i18n.js?v=7af9a938d4';

import { newsPostUrl } from './content-links.js?v=7af9a938d4';
...
import { initSmoothScroll, scrollToTop, holdScroll } from './smooth-scroll.js?v=7af9a938d4';
...
// <script src="main.js?v=7af9a938d4">. Each copy would otherwise append its own
