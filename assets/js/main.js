...
import { initI18n, getLang, setLanguage } from './i18n.js?v=95fe384fdc';

import { newsPostUrl } from './content-links.js?v=95fe384fdc';
...
import { initSmoothScroll, scrollToTop, holdScroll } from './smooth-scroll.js?v=95fe384fdc';
...
// <script src="main.js?v=95fe384fdc">. Each copy would otherwise append its own
