...
import { initI18n, getLang, setLanguage } from './i18n.js?v=90a2488fad';

import { newsPostUrl } from './content-links.js?v=90a2488fad';
...
import { initSmoothScroll, scrollToTop, holdScroll } from './smooth-scroll.js?v=90a2488fad';
...
// <script src="main.js?v=90a2488fad">. Each copy would otherwise append its own
