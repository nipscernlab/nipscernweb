...
import { initI18n, getLang, setLanguage } from './i18n.js?v=2bf10419ec';

import { newsPostUrl } from './content-links.js?v=2bf10419ec';
...
import { initSmoothScroll, scrollToTop, holdScroll } from './smooth-scroll.js?v=2bf10419ec';
...
// <script src="main.js?v=2bf10419ec">. Each copy would otherwise append its own
