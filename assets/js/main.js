...
import { initI18n, getLang, setLanguage } from './i18n.js?v=657881fd5a';

import { newsPostUrl } from './content-links.js?v=657881fd5a';
...
import { initSmoothScroll, scrollToTop, holdScroll } from './smooth-scroll.js?v=657881fd5a';
...
// <script src="main.js?v=657881fd5a">. Each copy would otherwise append its own
