...
import { publicationUrl, newsPostUrl } from './content-links.js?v=52b6de4b3d';
...
import { initMotion, revealFailsafe, stopDrift, ensureMotionLibs } from './motion.js?v=52b6de4b3d';
