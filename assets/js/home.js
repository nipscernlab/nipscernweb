...
import { publicationUrl, newsPostUrl } from './content-links.js?v=95fe384fdc';
import { scrollToEl } from './smooth-scroll.js?v=95fe384fdc';
...
import { initMotion, revealFailsafe, stopDrift, ensureMotionLibs } from './motion.js?v=95fe384fdc';
