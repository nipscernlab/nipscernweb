...
"en": {
  "hero": {"label": "Questions & Answers", "title": "The Big Questions, Answered",
    "subtitle": "What people ask about CERN, the ATLAS experiment and the NIPS-CERN projects, answered plainly by the lab that lives this work every day."},
...
"pt": {
  ...
  "a12": "O ATLAS é o maior detector de partículas de uso geral do Grande Colisor de Hádrons: 46 metros de comprimento, 25 de altura, cerca de 7.000 toneladas, a 100 metros de profundidade. Em 2012, ATLAS e CMS anunciaram a descoberta do bóson de Higgs. O NIPS-CERN contribui para o calorímetro TileCal dele; veja <a href=\"cern\">como</a>.",
  ...
  "a14": "A colaboração ATLAS reúne milhares de cientistas de cerca de 180 instituições em aproximadamente 40 países. O Brasil está entre eles, e a UFJF, por meio do NIPS-CERN, é uma das instituições participantes. Nossas contribuições estão detalhadas na <a href=\"cern\">página CERN & ATLAS</a>.",
  ...
  "a17": "O CERN Courier é a revista internacional da física de altas energias, publicada desde 1959. O NIPS-CERN mantém uma <a href=\"publications/courier\">coleção digital de edições</a> de 2013 até hoje, ao lado das nossas próprias <a href=\"publications\">publicações científicas</a>."
},
"fr": {
  "hero": {"label": "Questions et Réponses", "title": "Les grandes questions, avec leurs réponses",
    "subtitle": "Ce que l'on demande sur le CERN, l'expérience ATLAS et les projets du NIPS-CERN, expliqué simplement par le laboratoire qui vit ce travail au quotidien."},
  "cat_lab": "Le Laboratoire", "cat_projects": "Nos Projets", "cat_cern": "CERN & ATLAS",
  "q1": "Qu'est-ce que le NIPS-CERN ?",
  "a1": "Le NIPS-CERN (Núcleo de Instrumentação e Processamento de Sinais, Noyau d'Instrumentation et de Traitement du Signal) est un laboratoire de recherche et développement de l'Université Fédérale de Juiz de Fora (UFJF), au Brésil. Le laboratoire conçoit de l'instrumentation électronique, des méthodes de traitement du signal et des processeurs pour la physique des hautes énergies, en collaboration directe avec <a href=\"cern\">l'expérience ATLAS au CERN</a>. Découvrez <a href=\"about\">l'équipe et la mission</a>.",
  "q2": "Comment un laboratoire brésilien collabore-t-il avec le CERN ?",
  "a2": "Le NIPS-CERN contribue à l'exploitation et à l'étalonnage du calorimètre hadronique TileCal du détecteur ATLAS, développe des méthodes numériques de reconstruction des signaux utilisées dans le déclenchement des événements, et crée des logiciels comme <a href=\"projects/cgv\">CGVWeb</a>, affiché sur le grand écran de la salle de contrôle d'ATLAS à Genève. Les membres du laboratoire travaillent à l'UFJF et au CERN même ; l'histoire complète est sur notre <a href=\"cern\">page CERN & ATLAS</a>.",
  "q3": "Comment rejoindre le NIPS-CERN ou proposer un partenariat ?",
  ...
  "a12": "ATLAS est le plus grand détecteur polyvalent du Grand collisionneur de hadrons : 46 mètres de long, 25 de haut, environ 7 000 tonnes, à 100 mètres sous terre. En 2012, ATLAS et CMS ont annoncé la découverte du boson de Higgs. Le NIPS-CERN contribue à son calorimètre TileCal ; voyez <a href=\"cern\">comment</a>.",
  ...
  "a14": "La collaboration ATLAS réunit des milliers de scientifiques d'environ 180 institutions dans une quarantaine de pays. Le Brésil en fait partie, et l'UFJF, à travers le NIPS-CERN, est l'une des institutions participantes. Nos contributions sont détaillées sur la <a href=\"cern\">page CERN & ATLAS</a>.",
...
"no": {
  ...
  "a12": "ATLAS er den største allbruksdetektoren ved Large Hadron Collider: 46 meter lang, 25 meter høy, rundt 7 000 tonn, 100 meter under bakken. I 2012 kunngjorde ATLAS og CMS oppdagelsen av Higgs-bosonet. NIPS-CERN bidrar til TileCal-kalorimeteret; se <a href=\"cern\">hvordan</a>.",
  ...
  "a14": "ATLAS-samarbeidet samler tusenvis av forskere fra rundt 180 institusjoner i omtrent 40 land. Brasil er blant dem, og UFJF, gjennom NIPS-CERN, er en av institusjonene som deltar. Bidragene våre er beskrevet på <a href=\"cern\">CERN & ATLAS-siden</a>.",
  ...
  "a17": "CERN Courier er det internasjonale tidsskriftet for høyenergifysikk, utgitt siden 1959. NIPS-CERN holder en <a href=\"publications/courier\">digital samling av utgaver</a> fra 2013 til i dag, ved siden av våre egne <a href=\"publications\">vitenskapelige publikasjoner</a>."
}
}
